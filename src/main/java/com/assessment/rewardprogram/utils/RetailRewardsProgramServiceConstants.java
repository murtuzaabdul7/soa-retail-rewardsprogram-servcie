...
public class RetailRewardsProgramServiceConstants {
    ...
    public static final String MANDATORY_ATTRIBUTE_MISSING_CODE = "ERR001";
    public static final String MANDATORY_ATTRIBUTE_MISSING_MESSAGE = "Mandatory attribute is missing";
